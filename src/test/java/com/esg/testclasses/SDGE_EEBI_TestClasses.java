...
public static void NavigateToEnrollment() {
		//enterTextboxValue("SDGEEEBI", "MainMenu", "ESG Values", "SDGE_EEBI", 1, 1);
	linkText("Main Menu").click();
	linkText("Enrollments").click();	
	clickWebelement("SDGEEEBI", "NewEnrollment");
		selectDropdown("SDGEEEBI", "SelectProgram","SelectProgram",	 "ESG Values", "SDGE_EEBI", 2, 1);
		WaitForElement(3000, "SDGEEEBI", "NextButton");
...
public static void CompleteApplicationWorkflowStep() {
	...
	//clickWebelement("SDGEEEBI", "Tax_Id_or_SSN");
	//enterTextboxValue("SDGEEEBI", "Tax_Id_or_SSN", "ESG Values", "SDGE_EEBI", 21, 1);
	WaitForElement(3000, "SDGEEEBI", "Address_Section");
...
public static void CompleteMeasureAndProcessApplication() {
	...
	Enter(KeyEvent.VK_TAB);
	enterTextboxValue("SDGEEEBI", "CodeISPThermSavings", "ESG Values", "SDGE_EEBI", 43, 1);
	Enter(KeyEvent.VK_TAB);
