...
public class InspectionProcessTestClass extends HelperClass {
		...
		public static void InspectionCGIModule() {
			...
			enterValueByActionClass("InspectionProcess", "MeasureQTY", "ESG Values", "Inspection Process", 6, 1);
			...
			if(Pass.isEnabled())
			{
				enterValueByActionClass("InspectionProcess", "MeasurePassQTY", "ESG Values", "Inspection Process", 7, 1);
			}
			else
			{
			...
			if(Fail.isEnabled())
			{
				enterValueByActionClass("InspectionProcess", "MeasureFailQTY", "ESG Values", "Inspection Process", 8, 1);
			}
			else
			{
				System.out.println("Object is Disabled");
			...
			threadWait(2500);
			enterValueByActionClass("InspectionProcess", "FailCodeType", "ESG Values", "Inspection Process", 9, 1);
		...
		public static void InspectionRefusedModule() {
			...
			public static void CorrectionCGIModule() {
				...
				clickWebelement("InspectionProcess", "FailCode");
				enterValueByActionClass("InspectionProcess", "CorrectionInfo", "ESG Values", "Inspection Process", 11, 1);
				threadWait(2500);
			...
			public static void CorrectionNotCompletedModule() {
				...
				enterValueByActionClass("InspectionProcess", "CorrectionInfo", "ESG Values", "Inspection Process", 13, 1);
				selectDropdownByVisibleText("InspectionProcess", "EmployeeName", "ESG Values", "Inspection Process", 10, 1);
				selectActualReviewDate();
				clickonProcess();
				threadWait(2500);
			...
			public static void ReInspectionCGIModule() {
				...
				if(Pass1.isEnabled())
				{
					enterValueByActionClass("InspectionProcess", "MeasurePassQTY", "ESG Values", "Inspection Process", 8, 1);
				}
				else
				{
					System.out.println("Object is Disabled");
				...
				if(Fail1.isEnabled())
				{
					enterValueByActionClass("InspectionProcess", "MeasureFailQTY", "ESG Values", "Inspection Process", 7, 1);
				}
				else
				{
					System.out.println("Object is Disabled");
			...
			public static void ReInspectionRefusedModule() {
				...
				public static void FailCodeNoCorrectionRequired() {
					...
					clickWebelement("InspectionProcess", "FailCode");
					threadWait(2500);
					enterValueByActionClass("InspectionProcess", "FailCodeType", "ESG Values", "Inspection Process", 14, 1);
					threadWait(2500);
					Enter(KeyEvent.VK_DOWN);
					Enter(KeyEvent.VK_ENTER);
					threadWait(2500);
